...
class Container_2e4ace721e extends _PHPStan_a3459023a\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [
			['077', '087', '088', '092', '0217', '0384', '0385', '0386', '0394'],
		],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'fixerTmpDir' => '/var/folders/1g/km716ln91z911p0nzgjl0nt80000gn/T/phpstan-fixer',
			'analysedPaths' => null,
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2e4ace721e $container)
			{
	...
	public function createService053(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			'/Users/enzolarosa/Documents/Projects/translator',
			'/var/folders/1g/km716ln91z911p0nzgjl0nt80000gn/T/phpstan-fixer',
			['1.1.1.1']
		);
	}
	...
	public function createServiceContainer(): Container_2e4ace721e
	{
		return $this;
	}
